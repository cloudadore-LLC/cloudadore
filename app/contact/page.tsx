      ...
      <section className="w-full py-20 bg-gray-50 flex flex-col items-center">
        ...
        >
          {faqData.map((faq) => (
            ...
            >
              <Accordion.Header>
                <Accordion.Trigger className="flex w-full items-center justify-between px-5 py-4 text-left font-medium">
                  {faq.question}

                  <FiChevronDown className="transition-transform duration-200 AccordionChevron" />
                </Accordion.Trigger>
              </Accordion.Header>

              <Accordion.Content className="px-5 pb-4 text-gray-600">
                {faq.answer}
              </Accordion.Content>
            </Accordion.Item>
          ))}
