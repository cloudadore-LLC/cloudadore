...
const page = () => {
  return (
    <div>
      <section className="bg-black  text-white p-40 text-center">
        <h1 className="text-[60px] font-bold">About cloudadore</h1> <br />
        <p>
      ...
      <div className="max-w-7xl mx-auto ">
        <section className="my-8 grid gap-4 md:grid-cols-2">
          <div>
            At CloudAdore Club, we believe the cloud isn’t just technology, it’s
            a bridge to limitless possibilities. What began as a small group of
            enthusiasts exchanging ideas has grown into a thriving hub for cloud
            professionals, learners, and innovators from all walks of life. Our
            vision was simple: create a space where knowledge is shared openly,
            challenges turn into opportunities, and connections spark
            collaboration. We’ve seen how the right community can accelerate
            learning, inspire creativity, and fuel bold solutions. Today, we
            host workshops, collaborative projects, and networking opportunities
            that help members grow personally and professionally. From beginners
            to seasoned experts, our inclusive community thrives on diversity in
            skills, perspectives, and experiences. Our story is still being
            written and we invite you to be part of it. Here, your ideas can
            take flight, your skills can grow, and your passion for the cloud
            will be celebrated.
          </div>
